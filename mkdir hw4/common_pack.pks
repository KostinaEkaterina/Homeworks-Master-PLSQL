...
AS
  ...
  c_error_msg_final_status            constant varchar2(100 char) := 'Объект в конечном статусе. Изменения невозможны';
  ...
  c_error_code_final_status            constant number(10) := -20107; 
  c_error_code_object_notfound         constant number(10) := -20108; 
  c_error_code_object_already_locked   constant number(10) := -20109; 
  -- объекты исключений
